...
<div class="wrapper" style=" padding-top: 90px; height: 100%">
            ...
            <div class="box box-solid" style="background-color: #000000; ">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active" ><a href="deleteform.php" style="color:white;"><i class="fa fa-times" aria-hidden="true"></i>Delete Song</a></li>
                  ...
                  <table id="example2" class="table table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="deleteHandler.php?id=<?php echo $row['id']; ?>" onclick="return confirm('do you want to delete Y/N')">Delete</a></td>
